...
{
    BOOST_CHECK(TestSplitHost("www.dynamiccoin.org", "www.dynamiccoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.dynamiccoin.org]", "www.dynamiccoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.dynamiccoin.org:80", "www.dynamiccoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.dynamiccoin.org]:80", "www.dynamiccoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7333", "127.0.0.1", 7333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7333", "127.0.0.1", 7333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7333", "::ffff:127.0.0.1", 7333));
    BOOST_CHECK(TestSplitHost("[::]:7333", "::", 7333));
    BOOST_CHECK(TestSplitHost("::7333", "::7333", -1));
    BOOST_CHECK(TestSplitHost(":7333", "", 7333));
    BOOST_CHECK(TestSplitHost("[]:7333", "", 7333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7333", "127.0.0.1:7333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7333", "[::]:7333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
