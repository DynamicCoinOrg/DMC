...
QString BitcoinUnits::id(int unit)
{
    switch(unit)
    {
    case BTC: return QString("dmc");
    case mBTC: return QString("mdmc");
    case uBTC: return QString("udmc");
...
QString BitcoinUnits::name(int unit)
{
    ...
    case BTC: return QString("DMC");
    case mBTC: return QString("mDMC");
    case uBTC: return QString::fromUtf8("μDMC");
    default: return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DynamicCoins");
    case mBTC: return QString("Milli-DynamicCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-DynamicCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
QString BitcoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool omitRemainderIfZero, bool forceOmitRemainder)
{
...
QString BitcoinUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool omitRemainderIfZero, bool forceOmitRemainder)
{
